...
testament_1_abbreviation="OT"
testament_2="New Testament"
testament_2_abbreviation="NT"
...
testament_abbreviation_arr=("${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_1_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}" "${testament_2_abbreviation}")
